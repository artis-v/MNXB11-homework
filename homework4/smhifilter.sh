...
log "Filtering on only measurements taken in April, writing to $FILTER_FILTERFILENAME_ONLYAPRIL"
...
# MY FILTER #
#############
# Select only measurements done in the year 1983
FILTER_FILTERFILENAME_ONLYYEAR="onlyin1983_$FILTER_FILTEREDFILENAME"
log "Filtering on only measurements taken in 1983, writing to $FILTER_FILTERFILENAME_ONLYYEAR"
grep '1983\-' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLYYEAR
